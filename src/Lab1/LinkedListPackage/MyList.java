...
public class MyList {
    ...
    public void delete(Position p){
        //Проверяется корректность позиции и находим предыдущий узел
        Position previous =  findPrevious(p);

        //Удаляет элемент списка на позиции p.
        //Если удаляемый элемент — первый, то first переходит
        ...
        // элемент. Для этого вызывается метод findPrevious(p).
            ...
            //После того как найден предыдущий элемент, его поле nextNode переназначается
    ...
    public void printList(){
        //цикл от первого узла списка, пока p не станет равен null
        // В каждой итерации p обновляется ссылкой на следующий узел в списке: p.nextNode
