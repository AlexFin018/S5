...
class MyList {
    ...
    /**
     * Добавляем к списку имя и адрес
     * @param name имя
     * @param address адрес
     */
    protected void add(String name, String address){
        ...
        // Если список пустой, то запишем ссылку на новый элемент в head
        if(head == null) {
            head = le;
        }
    ...
    /**
     * Метод ищет последний элемент. Метод вызывается только, если head не null,
     * поэтому здесь не проверяем head на null
